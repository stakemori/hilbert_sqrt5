...
* Structure 3-20 check construction
#+BEGIN_SRC sage
...
* Structure 3-20
#+BEGIN_SRC sage
  [load_cand_wts(i) for i in range(3, 42)]
#+END_SRC
...
[[[3, 6]],
 ...
 [[2, 3, 3, 4, 4, 4, 6, 5, 5, 6, 7, 7], [9, 8, 9, 10, 11, 10, 11, 12, 12, 13]],
 [[2, 3, 3, 3, 4, 4, 5, 5, 6, 6, 6, 7], [8, 9, 9, 10, 10, 11, 11, 12, 12, 13]],
 [[2, 3, 3, 4, 4, 4, 6, 5, 5, 5, 6, 7],
  [9, 9, 10, 11, 10, 11, 10, 12, 12, 13]],
 ...
 [[2, 3, 3, 3, 4, 4, 4, 6, 5, 5, 6, 6, 7, 7],
  [9, 8, 9, 9, 10, 10, 11, 11, 12, 12, 12, 13]],
 [[2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 7],
  [8, 9, 9, 10, 10, 10, 11, 11, 12, 11, 12, 13]],
 [[2, 2, 3, 3, 4, 4, 6, 5, 5, 5, 5, 6, 6, 7],
  [8, 9, 9, 11, 10, 11, 11, 10, 12, 12, 12, 13]],
...
#+BEGIN_SRC sage :results table
  ...
  wts_l = [load_cand_wts(i) for i in range(4, max_wt)]
  for a in wts_l:
      a[0] = list(sorted(a[0]))
      a[1] = list(sorted(a[1]))
  [(i, a[0], a[1]) for i, a in zip(range(4, max_wt), wts_l)]
#+END_SRC
